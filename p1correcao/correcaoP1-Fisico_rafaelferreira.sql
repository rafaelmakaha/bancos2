...
CREATE TABLE email (
    ...
    email VARCHAR(50),
    CONSTRAINT PK_email PRIMARY KEY (matriculaFuncional),
...
CREATE TABLE possui (
    ...
    idDisciplina int(8) NOT NULL,
    CONSTRAINT FK_possui_CURSO FOREIGN KEY (idCurso) REFERENCES CURSO (idCurso) ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT FK_possui_DISCIPLINA FOREIGN KEY (idDisciplina) REFERENCES DISCIPLINA (idDisciplina) ON DELETE RESTRICT ON UPDATE RESTRICT
)ENGINE = InnoDB;